...
*/
bool BinaryCvMat::writeMatBinary(std::ofstream& ofs, const cv::Mat& out_mat)
{
	if (!ofs.is_open()) {
		return false;
	}
...
*/
bool BinaryCvMat::SaveMatBinary(const std::string& filename, const cv::Mat& output) {
...
*/
bool BinaryCvMat::readMatBinary(std::ifstream& ifs, cv::Mat& in_mat)
{
	if (!ifs.is_open()) {
		return false;
	}
...
*/
bool BinaryCvMat::LoadMatBinary(const std::string& filename, cv::Mat& output) {
